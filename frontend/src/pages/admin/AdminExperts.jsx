        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <main className="flex-1 p-8">
                ...
                <div className="flex items-center justify-between mb-8">
                    <div>
                        <h1 className="text-2xl font-bold text-gray-800">Manage Experts</h1>
              ...
              text-sm font-semibold hover:bg-purple-700 transition flex items-center gap-2"
                    >
                        <span>➕</span> Add Expert
                    </Link>
                </div>
                            ...
                            font-semibold">
                                                ...
                                                <td className="px-6 py-4">
                                                    <button
                                                        ...
                                                        className="bg-red-50 text-red-600 px-3 py-1.5 rounded-lg
                              text-xs font-semibold hover:bg-red-100 transition
                              disabled:opacity-50"
                                                    >
                                                        {deletingId === expert._id ? "Deleting..." : "Delete"}
                                                    </button>
                                                </td>
                                            </tr>
                                        ))
